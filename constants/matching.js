...
export const MATCH_PROFILES = [
  { id: 101, name: 'Sofia', age: 27, avatar: '👩', photos: ['🧘', '🌅', '📷'],
    city: 'Paris', distanceKm: 0.3, verified: true, zndScore: 890,
  ...
  { id: 102, name: 'Alex', age: 29, avatar: '👨', photos: ['🏃', '⚽', '🎮'],
    city: 'Paris', distanceKm: 0.5, verified: true, zndScore: 1240,
  ...
  { id: 103, name: 'Marcus', age: 31, avatar: '🧑', photos: ['⚽', '💼', '🎬'],
    city: 'Paris', distanceKm: 1.2, verified: false, zndScore: 2100,
  ...
  { id: 104, name: 'Priya', age: 26, avatar: '👩', photos: ['💻', '☕', '🎨'],
    city: 'Mumbai', distanceKm: 3.5, verified: true, zndScore: 3400,
  ...
  { id: 105, name: 'Léa', age: 24, avatar: '👩', photos: ['💃', '🎉', '🎵'],
    city: 'Paris', distanceKm: 0.8, verified: true, zndScore: 640,
  ...
  { id: 106, name: 'Diego', age: 28, avatar: '🧑', photos: ['🍳', '📚', '🌿'],
    city: 'Madrid', distanceKm: 12, verified: false, zndScore: 780,
  ...
  { id: 107, name: 'Amara', age: 30, avatar: '👩', photos: ['🐾', '🌿', '📷'],
    city: 'Lagos', distanceKm: 25, verified: true, zndScore: 1560,
  ...
  { id: 110, name: 'Yuki', age: 26, avatar: '👩', photos: ['📷', '✈️', '🍳'],
    city: 'Delhi', distanceKm: 7, verified: true, zndScore: 990,
